...
/**
 * @package ContactMessage Model
 * @author Amadi Ifeanyi <amadiify.com>
 */
class ContactMessage implements ModelInterface
{
    /**
    ...
    public function Fillable(RequestData $data) : void
    {
        ...
        // unpack data
        $this->ID = $data->get('id', $data->get('contactid', $this->ID));
        ...
        $this->CustomerMessage = $data->get('review', $data->customer_message);
    }
    ...
    public function Create() : bool
    {
       ...
       $table = $this->DB(Table::CONTACT_BOX);
