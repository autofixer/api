...
/**
 * @package GeneralStatus Model
 * @author Amadi Ifeanyi <amadiify.com>
 */
class GeneralStatus implements ModelInterface
{
    /**
    ...
    public function Fillable(RequestData $data) : void
    {
        ...
        // unpack data
        $this->ID = $data->get('id', $data->get('statusid', $this->ID));
        $this->StatusName = $data->get('status_name');
    }
    ...
    public function Read()
    {
        // @var Query $query
        // don't forget to pass a table name to DB()
        $query = $this->Filter($this->DB(Table::STATUS), [
