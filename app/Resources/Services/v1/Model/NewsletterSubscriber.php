...
/**
 * @package NewsletterSubscriber Model
 * @author Amadi Ifeanyi <amadiify.com>
 */
class NewsletterSubscriber implements ModelInterface
{
    /**
     ...
     */
    const PRIMARY_KEY = 'subscriberid';
    ...
    public function Fillable(RequestData $data) : void
    {
        ...
        // unpack data
        $this->id = $data->get('id', $data->get('subscriberid', $this->id));
        $this->Email = $data->get('email', $data->email_address);
    ...
    public function Create() : bool
    {
       ...
       $table = $this->DB(Table::NEWSLETTER_SUBSCRIBER);

       // record does not exists
       if ($this->isFreshData($data, $table)) :
    ...
    public function Read()
    {
        // @var Query $query
        // don't forget to pass a table name to DB()
        $query = $this->Filter($this->DB(Table::NEWSLETTER_SUBSCRIBER), [
